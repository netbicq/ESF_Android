...
public class GetEmpTaskByQRCoderModel extends MvpModel<GetEmpTaskByQRCoderModel.Request, GetEmpTaskByQRCoderModel.Response> {
    @Override
    public void getResponse(Request request, MvpCallback<Response> callback) {
        apiApp.getEmpTaskByQRCoder(request.getDangerPointID())
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    @Override
                    public void onNext(GetEmpTaskByQRCoderModel.Response response) {
