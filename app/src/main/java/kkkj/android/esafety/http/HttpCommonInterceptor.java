...
//        Log.d("HttpCommonInterceptor","add common params");
        ...
        //添加公共参数,添加到header中
        mHeaderParamsMap.put("Token",  ESafety.getInstance().getCommonParts().get("Token")+"");
        mHeaderParamsMap.put("AccountID",  ESafety.getInstance().getCommonParts().get("AccountID")+"");
