package kkkj.android.esafety.login.view;
...
import kkkj.android.esafety.MainActivity;
...
import kkkj.android.esafety.login.presenter.LoginPresenter;
...
//                startActivity(new Intent(mContext,RegistActivity.class));
    ...
    public void signSuc(SignInModel.Response response) {
        ESafety.getInstance().setCommonParts(SharedPreferenceUtil.getString(SharedPreferenceUtil.SP_Commonparts_Token)
                ,SharedPreferenceUtil.getString(SharedPreferenceUtil.SP_Commonparts_AccountID));
        if(response.getData()!=null)
        {
            ESafety.getInstance().setUserProfile(response.getData().getUserProfile());
