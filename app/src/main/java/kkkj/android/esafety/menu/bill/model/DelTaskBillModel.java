...
public class DelTaskBillModel extends MvpModel<DelTaskBillModel.Request, DelTaskBillModel.Response> {
    @Override
    public void getResponse(Request request, MvpCallback<Response> callback) {
        apiApp.deltaskbill(request.getBillid()).subscribeOn(Schedulers.io())//IO线程加载数据
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    @Override
                    public void onNext(DelTaskBillModel.Response response) {
