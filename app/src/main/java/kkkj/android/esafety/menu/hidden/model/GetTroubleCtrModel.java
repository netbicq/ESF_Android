...
public class GetTroubleCtrModel extends MvpModel<GetTroubleCtrModel.Request, GetTroubleCtrModel.Response> {
    @Override
    public void getResponse(Request request, MvpCallback<Response> callback) {
        apiApp.getTroubleCtr()
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    @Override
                    public void onNext(GetTroubleCtrModel.Response response) {
    ...
    public static class Response extends ESafetyResponse {
        List<APPTroubleCtrView> data;

        public List<APPTroubleCtrView> getData() {
            if(data==null)
            {
