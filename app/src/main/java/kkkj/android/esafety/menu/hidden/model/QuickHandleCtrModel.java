...
public class QuickHandleCtrModel extends MvpModel<QuickHandleCtrModel.Request, QuickHandleCtrModel.Response> {
    @Override
    public void getResponse(Request request, MvpCallback<Response> callback) {
        apiApp.quickHandleCtr(request)
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    @Override
                    public void onNext(QuickHandleCtrModel.Response response) {
