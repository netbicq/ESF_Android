...
public class TransferPrincipalModel extends MvpModel<TransferPrincipalModel.Request, TransferPrincipalModel.Response> {
    @Override
    public void getResponse(Request request, MvpCallback<Response> callback) {
        apiApp.transferPrincipal(request)
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    @Override
                    public void onNext(TransferPrincipalModel.Response response) {
