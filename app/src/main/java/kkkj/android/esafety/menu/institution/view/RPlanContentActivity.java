...
import kkkj.android.esafety.menu.institution.presenter.RPlanContentPresenter;
import kkkj.android.esafety.mvpInterface.MvpBaseActivity;

/**
 * 预案内容
 */
public class RPlanContentActivity extends MvpBaseActivity<RPlanContentPresenter> implements RPlanContentContract.View {
    ...
    @Override
    protected RPlanContentPresenter getPresenter() {
        return new RPlanContentPresenter();
    }

    @Override
    protected void initMonitorAndData() {

        docsolutionid = getIntent().getStringExtra("docsolutionid");
...
//        webView.setWebChromeClient(mInsideWebChromeClient);
    ...
    @Override
    public void getdocsolutionmodelSuc(PhoneDocSolutionModelView data) {
    ...
    public void onResume() {
        super.onResume();
        webView.onResume();
        GetdocSolutionModel.Request request =new GetdocSolutionModel.Request();
        request.setDocsolutionid(docsolutionid);
        mPresenter.getdocsolutionmodel(request);
    }
