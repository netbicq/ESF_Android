...
public class GetDangerLevelsModel extends MvpModel<GetDangerLevelsModel.Request, GetDangerLevelsModel.Response> {
    @Override
    public void getResponse(Request request, MvpCallback<Response> callback) {
        apiApp.getDangerLevels()
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    @Override
                    public void onNext(GetDangerLevelsModel.Response response) {
    ...
    public static class Response extends ESafetyResponse {
        List<StatisticsDangerLevel> data;

        public List<StatisticsDangerLevel> getData() {
            if(data==null)
            {
