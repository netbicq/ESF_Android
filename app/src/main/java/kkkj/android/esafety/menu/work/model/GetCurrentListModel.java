...
public class GetCurrentListModel extends MvpModel<GetCurrentListModel.Request, GetCurrentListModel.Response> {
    @Override
    public void getResponse(Request request, MvpCallback<Response> callback) {
        apiApp.getcurrentlist()
                ...
                .subscribe(new Observer<Response>() {
                    ...
                    @Override
                    public void onNext(GetCurrentListModel.Response response) {
