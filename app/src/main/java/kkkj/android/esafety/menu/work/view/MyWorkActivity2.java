 ...
 * 我的作业
 */
public class MyWorkActivity2 extends MvpBaseActivity {
    @BindView(R.id.tl_1)
    ...
    protected void initMonitorAndData() {
        action_bar_title.setText("我的作业");
        String[] mTitles = {"当前", "已完成"};
        ...
        fragments.add(new CurrentWorkFragment());
        fragments.add(new HistoricalWorkFragment());
