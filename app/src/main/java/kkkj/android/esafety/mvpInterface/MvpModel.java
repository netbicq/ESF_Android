...
import kkkj.android.esafety.http.api.APIApp;
import kkkj.android.esafety.http.api.APIAttachfile;
import kkkj.android.esafety.http.api.APIAuth;

/**
 * MVP Model基类
 * @param <T>
 */
public class MvpModel<T extends ESafetyRequest,E extends ESafetyResponse> {
    //对应HTTP的状态码
